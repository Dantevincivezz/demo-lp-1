  ...
  return (
    <footer className="pt-10 bg-gray-800">
      <div className="max-w-screen-xl mx-auto px-4 md:px-8">
        ...
        <div className="mt-10 py-10 border-t border-gray-700 items-center justify-between flex">
          <span className="flex justify-center content-center center">
            <p className="text-gray-300">© 2023 Copyright : </p>
            <a
              href="www.vezzco.com"
              className="px-2 text-white hover:text-lime-400"
            >
              VezzCo
            </a>
          </span>
